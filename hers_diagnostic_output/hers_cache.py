...
class HERSCache:
    ...
    def arco2(self):
        if self.arco2_set:
            ...
            self.arco2 = self.hers_diagnostic_output.co2_reference_home_output.emissions_annual_total  # lbs
            return self._arco2
    ...
    def tnml(self):
        if self.tnml_set:
            ...
            self.tnml = self.nmeul_heat + self.nmeul_cool + self.nmeul_hw + self.ec_la + self.ec_vent + self.ec_dh  # MBtu
    ...
    def trl(self):
        if self.trl_set:
            ...
            self.trl = self.reul_heat + self.reul_cool + self.reul_hw + self.rec_la + self.rec_vent + self.rec_dh  # MBtu
            return self._trl
    ...
    def tnml_iad(self):
        if self.tnml_iad_set:
            ...
            self.tnml_iad = self.nmeul_heat_iad + self.nmeul_cool_iad + self.nmeul_hw_iad + self.ec_la_iad + self.ec_vent_iad + self.ec_dh_iad  # MBtu
            return self._tnml_iad
    ...
    def trl_iad(self):
        if self.trl_iad_set:
            ...
            self.trl_iad = self.reul_heat_iad + self.reul_cool_iad + self.reul_hw_iad + self.rec_la_iad + self.rec_vent_iad + self.rec_dh_iad  # MBtu
            return self._trl_iad
    ...
    def ec_la(self):
        if self.ec_la_set:
            ...
            self.ec_la = convert(self.hers_diagnostic_output.rated_home_output.lighting_and_appliance_energy.energy_annual_total, "kBtu", "MBtu")
            return self._ec_la
    ...
    def ec_vent(self):
        if self.ec_vent_set:
            ...
            self.ec_vent = convert(self.hers_diagnostic_output.rated_home_output.ventilation_energy.energy_annual_total, "kBtu", "MBtu")
            return self._ec_vent
    ...
    def ec_dh(self):
        if self.ec_dh_set:
            ...
            self.ec_dh = convert(self.hers_diagnostic_output.rated_home_output.dehumidification_energy.energy_annual_total, "kBtu", "MBtu")
            return self._ec_dh
    ...
    def reul_heat(self):
        if self.reul_heat_set:
            ...
            self.reul_heat = convert(
                self.hers_diagnostic_output.hers_reference_home_output.space_heating_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_heat
    ...
    def reul_cool(self):
        if self.reul_cool_set:
            ...
            self.reul_cool = convert(
                self.hers_diagnostic_output.hers_reference_home_output.space_cooling_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_cool
    ...
    def reul_hw(self):
        if self.reul_hw_set:
            ...
            self.reul_hw = convert(
                self.hers_diagnostic_output.hers_reference_home_output.water_heating_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_hw
    ...
    def rec_la(self):
        if self.rec_la_set:
            ...
            self.rec_la = convert(
                self.hers_diagnostic_output.hers_reference_home_output.lighting_and_appliance_energy.energy_annual_total, "kBtu", "MBtu"
            )
            return self._rec_la
    ...
    def rec_vent(self):
        if self.rec_vent_set:
            ...
            self.rec_vent = convert(self.hers_diagnostic_output.hers_reference_home_output.ventilation_energy.energy_annual_total, "kBtu", "MBtu")
            return self._rec_vent
    ...
    def rec_dh(self):
        if self.rec_dh_set:
            ...
            self.rec_dh = convert(self.hers_diagnostic_output.hers_reference_home_output.dehumidification_energy.energy_annual_total, "kBtu", "MBtu")
            return self._rec_dh
    ...
    def ec_la_iad(self):
        if self.ec_la_iad_set:
            ...
            self.ec_la_iad = convert(
                self.hers_diagnostic_output.iad_rated_home_output.lighting_and_appliance_energy.energy_annual_total, "kBtu", "MBtu"
            )
            return self._ec_la_iad
    ...
    def ec_vent_iad(self):
        if self.ec_vent_iad_set:
            ...
            self.ec_vent_iad = convert(self.hers_diagnostic_output.iad_rated_home_output.ventilation_energy.energy_annual_total, "kBtu", "MBtu")
            return self._ec_vent_iad
    ...
    def ec_dh_iad(self):
        if self.ec_dh_iad_set:
            ...
            self.ec_dh_iad = convert(self.hers_diagnostic_output.iad_rated_home_output.dehumidification_energy.energy_annual_total, "kBtu", "MBtu")
            return self._ec_dh_iad
    ...
    def reul_heat_iad(self):
        if self.reul_heat_iad_set:
            ...
            self.reul_heat_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.space_heating_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_heat_iad
    ...
    def reul_cool_iad(self):
        if self.reul_cool_iad_set:
            ...
            self.reul_cool_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.space_cooling_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_cool_iad
    ...
    def reul_hw_iad(self):
        if self.reul_hw_iad_set:
            ...
            self.reul_hw_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.water_heating_system_output.load_annual_total, "kBtu", "MBtu"
            )
            return self._reul_hw_iad
    ...
    def rec_la_iad(self):
        if self.rec_la_iad_set:
            ...
            self.rec_la_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.lighting_and_appliance_energy.energy_annual_total, "kBtu", "MBtu"
            )
            return self._rec_la_iad
    ...
    def rec_vent_iad(self):
        if self.rec_vent_iad_set:
            ...
            self.rec_vent_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.ventilation_energy.energy_annual_total, "kBtu", "MBtu"
            )
            return self._rec_vent_iad
    ...
    def rec_dh_iad(self):
        if self.rec_dh_iad_set:
            ...
            self.rec_dh_iad = convert(
                self.hers_diagnostic_output.iad_hers_reference_home_output.dehumidification_energy.energy_annual_total, "kBtu", "MBtu"
            )
            return self._rec_dh_iad
