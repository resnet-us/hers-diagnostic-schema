        ...
        for home_type in self.home_types:
            ...
            for system_type_output in self.data[f"{home_type}_output"]:
                ...
                if system_type in self.system_types:
                    ...
                    energy_system_data[home_type][system_type][
                        "annual_system_energy_use"
                    ] = 0
                    # energy_system_data[home_type][system_type]['hourly_system_energy_use'] = [0] * 8760
                    for system_index in range(
                        len(self.data[f"{home_type}_output"][system_type_output])
                    ):
                        energy_system_data[home_type][system_type][
                            "primary_fuel_type"
                        ] = self.data[f"{home_type}_output"][system_type_output][
                            system_index
                        ][
                            "primary_fuel_type"
                        ]
                        ...
                        for sub_system_number, sub_system in enumerate(
                            self.data[f"{home_type}_output"][system_type_output][
                                system_index
                            ]["energy_use"]
                        ):
                            ...
                            tuple = (
                                ...
                                f"sub_system_index: {sub_system_number}",
                            )
                            ...
                            energy_system_data[home_type][system_type][tuple][
                                "fuel_type"
                            ] = sub_system["fuel_type"]

                            energy_system_data[home_type][system_type][tuple][
                                "annual_energy_use"
                            ] = sum(sub_system["energy"])
                            energy_system_data[home_type][system_type][
                                "annual_system_energy_use"
                            ] += energy_system_data[home_type][system_type][tuple][
                                "annual_energy_use"
